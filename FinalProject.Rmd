...
model_icu1 <- lm(gh_reg_icu1$log_losday~ ., data = gh_reg_icu1)
anova(model_icu1)
step1 <- update(model_icu1 , . ~ . -bpsystolic)
anova(step1)
step2 <- update(step1, . ~ . -respirationrate)
anova(step2)
step3 <- update(step2, . ~ . -gender)
anova(step3)
step4 <- update(step3, . ~ . -bpdiastolic)
anova(step4)
step5 <- update(step4, . ~ . -race)
anova(step5)
step6 <- update(step5, . ~ . -religion)
anova(step6)
step7 <- update(step6, . ~ . -heartrate )
anova(step7)
summary(step7)
